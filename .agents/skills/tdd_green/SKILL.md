...
2. Ejecuta la suite de pruebas nuevamente. RECUERDA: no encadenes comandos con `&&` ya que estamos en Windows. Usa múltiples llamadas o ejecútalo secuencialmente.
